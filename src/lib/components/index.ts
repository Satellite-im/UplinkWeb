...
export {default as Controls} from "$lib/components/ui/Controls.svelte"
...
export {default as NewPayment} from "$lib/components/payments/NewPayment.svelte"
export {default as OrderedPhrase} from "$lib/components/settings/OrderedPhrase.svelte"
export {default as PaymentSuccessSplash} from "$lib/components/payments/PaymentSuccessSplash.svelte"
export {default as PinInput} from "$lib/components/PinInput.svelte"
export {default as File} from "$lib/components/files/File.svelte"
export {default as Folder} from "$lib/components/files/Folder.svelte"
...
export {default as MessageContainer} from "$lib/components/messaging/MessageContainer.svelte"
