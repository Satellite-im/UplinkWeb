...
let mock_chats: Chat[] = [
    ...
    },
    {
        ...
        notifications: 4,
        activity: false,
        users: [defaultUser, mock_users[0]],
        last_message_at: new Date(),
    ...
    },
    {
        ...
        notifications: 2,
        activity: true,
        users: [defaultUser, mock_users[1]],
        last_message_at: new Date(),
        last_message_preview: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    },
    {
        ...
        activity: false,
        notifications: 0,
        users: [defaultUser, mock_users[2]],
        last_message_at: new Date(),
        last_message_preview: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    },
    {
        ...
        activity: false,
        notifications: 0,
        users: [defaultUser, mock_users[3]],
        last_message_at: new Date(),
        last_message_preview: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    },
    {
        ...
        activity: false,
        notifications: 0,
        users: [defaultUser, mock_users[4]],
        last_message_at: new Date(),
        last_message_preview: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    },
]
