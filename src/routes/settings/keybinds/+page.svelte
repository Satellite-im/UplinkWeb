<script lang="ts">
    import { Banner, Key } from "src/lib/components"
    import KeyboardListener from "src/lib/components/ui/KeyboardListener.svelte"
    import { Button, Icon, Label, Select, Spacer, Text } from "src/lib/elements"
    import { Appearance, KeybindAction, KeybindState, Shape, Size } from "src/lib/enums"
    import { initLocale } from "src/lib/lang"
    import { SettingSection } from "src/lib/layouts"
    import { defaultKeybinds, SettingsStore, type ISettingsState } from "src/lib/state"
