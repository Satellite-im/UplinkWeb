<script lang="ts">
    import { Appearance, Route, Shape, Size, Status } from "src/lib/enums"
    import { initLocale } from "src/lib/lang"
    import { _ } from "svelte-i18n"
    import { SettingSection } from "src/lib/layouts"
    import { ProfilePicture, OrderedPhrase, ContextMenu } from "src/lib/components"
    import { Button, Icon, Label, Input, Text, Select, Checkbox } from "src/lib/elements"
    import { Store } from "src/lib/state/store"
    import type { User } from "src/lib/types"
    import FileUploadButton from "src/lib/components/ui/FileUploadButton.svelte"
    import Controls from "src/lib/layouts/Controls.svelte"
    import { get } from "svelte/store"
    import { goto } from "$app/navigation"
    import { ToastMessage } from "src/lib/state/ui/toast"
