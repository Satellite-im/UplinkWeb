<script lang="ts">
    import { Button, Icon, Label, Text, Input } from "src/lib/elements"
    import { ChatPreview, ContextMenu, Modal } from "src/lib/components"
    import { Sidebar, Topbar } from "src/lib/layouts"
    import { Appearance, MessageDirection, Route, Shape, Size, TooltipPosition } from "src/lib/enums"
    import { initLocale } from "src/lib/lang"
    import { _ } from "svelte-i18n"
    import type { Chat, User } from "src/lib/types"
    import Fuse from "fuse.js"
    import Friend from "src/lib/components/friends/Friend.svelte"
    import { Store } from "src/lib/state/store"
    import { get } from "svelte/store"
    import { goto } from "$app/navigation"
    import { UIStore } from "src/lib/state/ui"
    import { MultipassStoreInstance } from "src/lib/wasm/MultipassStore"
    import { defaultUser, defaultChat, type FriendRequest, hashChat, type Message, type MessageGroup, type FileInfo, type Frame } from "src/lib/types"
    import { onMount } from "svelte"
    import type { WarpError } from "src/lib/wasm/HandleWarpErrors"
    import Key from "src/lib/components/settings/Key.svelte"
