<script lang="ts">
    ...
    let stepLabels: string[] = ["Fetching your friends from space.", "Aligning multiple satellites.", "Spinning up warp drives.", "Initalizing forward shields for maximum saftey.", "Almost ready, finalizing."]
    let step: number = 0
