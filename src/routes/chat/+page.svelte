<script lang="ts">
    import { Appearance, ChatType, MessageAttachmentKind, MessagePosition, Route, Shape, Size, TooltipPosition } from "src/lib/enums"
    ...
    import { Chatbar, Sidebar, Topbar, Profile } from "src/lib/layouts"
    import {
        FileEmbed,
        PopupButton,
        ImageEmbed,
    ...
    import { Button, Icon, Label, Text } from "src/lib/elements"
    import CallScreen from "src/lib/components/calling/CallScreen.svelte"
    import { type Chat, type User } from "src/lib/types"
    import EncryptedNotice from "src/lib/components/messaging/EncryptedNotice.svelte"
    import { Store } from "src/lib/state/store"
    import { get } from "svelte/store"
    import { goto } from "$app/navigation"
    import { UIStore } from "src/lib/state/ui"
    import CreateGroup from "src/lib/components/group/CreateGroup.svelte"
    import { ConversationStore } from "src/lib/state/conversation"
    import GroupSettings from "src/lib/components/group/GroupSettings.svelte"
    import ViewMembers from "src/lib/components/group/ViewMembers.svelte"
    import AudioEmbed from "src/lib/components/messaging/embeds/AudioEmbed.svelte"
    import VideoEmbed from "src/lib/components/messaging/embeds/VideoEmbed.svelte"
    import Market from "src/lib/components/market/Market.svelte"
    ...
    import PendingMessage from "src/lib/components/messaging/message/PendingMessage.svelte"
    import PendingMessageGroup from "src/lib/components/messaging/PendingMessageGroup.svelte"
