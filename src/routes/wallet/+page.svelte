<script lang="ts">
    import { Appearance, Route, Shape, Size } from "src/lib/enums"
    ...
    import { Transaction } from "src/lib/components"
    import ProfilePicture from "src/lib/components/profile/ProfilePicture.svelte"
    import Text from "src/lib/elements/Text.svelte"
    import Input from "src/lib/elements/Input/Input.svelte"
    import { balance, recent_transactions, transactions_in, transactions_out } from "src/lib/mock/wallet"
    import TransactionContainer from "src/lib/components/wallet/TransactionContainer.svelte"
    ...
    import NewPayment from "src/lib/components/wallet/payments/NewPayment.svelte"
