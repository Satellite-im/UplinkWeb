<script lang="ts">
    ...
    import { Toasts } from "src/lib/components"
    import Key from "src/lib/components/settings/Key.svelte"
    import KeyboardListener from "src/lib/components/ui/KeyboardListener.svelte"
    import { Sound, Sounds } from "src/lib/components/utils/Sounds"
    import { Font, KeybindAction, KeybindState, Route } from "src/lib/enums"
    ...
    import { RelayStore } from "src/lib/state/wasm/relays"
    import type { Keybind } from "src/lib/types"
    import { log } from "src/lib/utils/Logger"
    import { MultipassStoreInstance } from "src/lib/wasm/MultipassStore"
    import { TesseractStoreInstance } from "src/lib/wasm/TesseractStore"
